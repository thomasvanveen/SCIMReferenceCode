...
{
    public class ScimInMemoryProvider : ProviderBase
    {
        private readonly ProviderBase groupProvider;
        private readonly ProviderBase userProvider;

        public ScimInMemoryProvider()
        {
            groupProvider = new ScimInMemoryGroupProvider();
            userProvider = new ScimInMemoryUserProvider();
        }
